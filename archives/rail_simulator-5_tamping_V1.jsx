            ...
            <div>
              ...
              {asr&&(
                <div>
                  ...
                  <div style={{display:"flex",gap:6,marginBottom:12}}>
                    {[["wear","Wear V and L"],["rcf","RCF Index"],["reserve","Metal Reserve"],["plan","Schedule"],["cost","Replacement Cost"],["grind","Grinding Cost"],["repr","Reprofiling Cost"],["tamp","Ballast Tamping"],["cmp","Strategy Comparison"]].map(function(item){return <Btn key={item[0]} onClick={function(){setCt(item[0]);}} active={ctab===item[0]} sm={true}>{item[1]}</Btn>;})}
                  </div>
